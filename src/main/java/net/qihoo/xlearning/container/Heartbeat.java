...
public class Heartbeat extends Thread {
  ...
  public void run() {
    ...
    try {
      ...
      LOG.info(containerId + " : interrupted ...");
  ...
  public HeartbeatResponse heartbeatWithRetry() {
    ...
    while (true) {
      try {
        ...
        LOG.info(containerId + " : Send HeartBeat to ApplicationMaster");
  ...
  public void heartbeatResponseHandle(HeartbeatResponse heartbeatResponse) {
    LOG.info("Received the heartbeat response from the AM. CurrentJob finished " + heartbeatResponse.getIsXLearningTrainCompleted()
